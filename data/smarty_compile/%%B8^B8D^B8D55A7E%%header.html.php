...
-------"><?php echo $this->_tpl_vars['layer33']['title']; ?>
		...
		<ul class="nav_main clrfix">
			<li<?php if ($this->_tpl_vars['enname'] == ''): ?> class="nav_on"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
">首页</a></li>
			<li<?php if ($this->_tpl_vars['enname'] == 'visa'): ?> class="nav_on"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/visa">签证</a></li><?php $_from = $this->_tpl_vars['layer']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['layeritem']):
?>
			<li<?php if ($this->_tpl_vars['enname'] == $this->_tpl_vars['layeritem']['html']): ?> class="nav_on"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/<?php echo $this->_tpl_vars['layeritem']['html']; ?>
"><?php echo $this->_tpl_vars['layeritem']['title']; ?>
</a></li>
			<?php endforeach; endif; unset($_from); ?>
			<li <?php if ($this->_tpl_vars['enname'] == 'custom'): ?> class="nav_on"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/custom">私人定制</a></li>
			<li <?php if ($this->_tpl_vars['enname'] == 'scenic'): ?> class="nav_on"<?php endif; ?>><a href="<?php echo $this->_tpl_vars['siteurl']; ?>
/scenic">景点门票</a></li>
		</ul>
	</div>
</div>