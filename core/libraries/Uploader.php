...
// ===========================头像裁切尺寸
  public $AVATAR_WIDTH=90;
  public $AVATAR_HEIGHT=90;

  public $AVATAR_S_WIDTH=60;
  public $AVATAR_S_HEIGHT=60;

  // ===========================最大图片尺寸，过大时将自动按比例缩小，防止超大图片撑破页面
  public $AVATAR_MAX_WIDTH=200;
  public $AVATAR_MAX_HEIGHT=200;

  public  $MAX_UPLOAD_SIZE=2097152;  //最大允许上传的图片大小(1M = 1024 * 1024 = 1048576)
  public  $ALLOW_UPLOAD_IMAGE_TYPES='jpg, jpeg, png, gif'; // 允许上传的图片类型
  ...
  public function __construct( $allow_upload_types = array(), $limit_size = null)
  {
    ...
    {
      $this->handler = new uploader_form(); /*第一种形式*/
    }
    else
    {
      $this->handler = new uploader_xhr();/*第二种形式*/
    }
  }
