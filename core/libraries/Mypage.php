...
class Mypage {
  ...
  function initialize($params)
  {
    if (count($params) > 0)
    {
      ...
      $this->next_page=isset($params['next_page']) ? $params['next_page'] : '';
      $this->pre_page=isset($params['pre_page']) ? $params['pre_page'] : '';
  ...
  function next_page($style='pg_next')
  {
    ...
    return '<span class="'.$style.'"style="border:1px solid #e5edf0">'.$this->next_page.'</span>';
  }
  ...
  function pre_page($style='pg_pre')
  {
    ...
    return '<span class="'.$style.' "style="border: 1px solid #e5edf0" >'.$this->pre_page.'</span>';
  }
  ...
  function _get_link($url,$text,$style=''){
    ...
    return '<a '.$style.' href="javascript:void(0);">'.$text.'</a>';
  }
