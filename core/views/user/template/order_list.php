                    ...
                    <li>
                        ...
                        <span>
                            ...
                            <div class="order_actions">
                                ...
                                <?php elseif($v->productType=="Flight"):?>
                                    <span>查看</span>
                                <?php endif?>
                            </div>
                        </div>
                ...
                <?php elseif($v->productType=="Package_T"):?>
                    <li>
                        <p class="list_top clearfix">
                            ...
                            <span class="order_no">订单号&nbsp;:&nbsp;<i><?php echo $v->bookingRefNo;?></i></span>
                            <span class="order_date">预定日期&nbsp;:&nbsp;<?php echo substr($v->travelStartDate,0,10);?></span>
                        </p>
                        <!--细节-->
                        <div class="order_out clearfix">
                            <div class="order_name">
                        ...
                        <span>
                            ...
                            <div class="order_actions">
                                <?php if($v->productType=="Package_T"):?>
                ...
                <?php elseif($v->productType=="Hotel"):?>
                    <li>
                        ...
                        <div class="order_out clearfix">
                            ...
                            <div class="order_status">
                        <span>
                           <?php if($v->bookingStatus=="Canceled"):?>
                               已取消
                           <?php else:?>
                            <?php echo get_order_status($v->paymentStatus);?>
                           <?php endif;?>
                        </span>
                            </div>
                            <div class="order_actions">
                                <?php if($v->productType=="Hotel"):?>
                ...
                <?php elseif($v->productType=="Package_HT"):?>
                    <li>
                        ...
                        <span>
                            ...
                            <div class="order_actions">
                                <?php if($v->productType=="Package_HT"):?>
                ...
                <?php elseif($v->productType=="Package_FHT"):?>
                    <li>
                        ...
                        <span>
                            ...
                            <div class="order_actions">
                                <?php if($v->productType=="Package_FHT"):?>
