                ...
                <li class="list_item clearfix">
                    ...
                    <div class="p_wrap">
                        ...
                        <p>
                            ...
                            <span
                                class="from_date"><?php echo string_cut($v1->salesFrom, 0, 4) . '年' . string_cut($v1->salesFrom, 5, 2) . '月' . string_cut($v1->salesFrom, 8, 2) . '日'; ?></span>
                            至 <span
...
<!--                        </p>-->
                    ...
                    <div class="price_num">
                        <div class="mon_tag">
                            <?php echo $v1->currencyCode == "CNY" ? "￥" : "$"; ?><span
                                class="price_value"><?php echo $v1->leadinPrice; ?></span>起/人
                        </div>
                        <button class="search_detail"
                                onclick="vlm.Utils.OpenWin('/ticket/detail?packageId=<?php echo $v1->packageID;?>&price=<?php echo $v1->leadinPrice;?>')">
                            查看详情
                        </button>
                    </div>
                </li>
