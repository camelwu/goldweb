...
<div class="all">
  ...
  <div banner-index search-index input-prompt>
    <?php foreach($banner->data->bannerList as $item): ?>
    <div class="banner" style="background-image:url(<?php echo $item->bannerPicUrl ?>)"></div>
    <?php endforeach; ?>
        ...
        <div class="search_tab">
          <div class="tab_font" id="tab1">
            ...
            <div class="date clearfix">
              ...
              <p class="fl pr">
                <i class="icon_date"></i>
                <input id="readonly" class="public" type="text" placeholder="YYYY-MM-DD" readonly>
