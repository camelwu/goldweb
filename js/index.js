...
function responsive(){//页面宽度响应式
	...
	if(zw<1200){
		...
		$(".comm_login li").stop(false).animate({marginRight:"1.2%"},200);
		...
		$(".comm_login li").stop(false).animate({marginRight:"4.6%"},200);
		$(".comm_login .comm_pf").stop(false).animate({marginRight:0},200);
