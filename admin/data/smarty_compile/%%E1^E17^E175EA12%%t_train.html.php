<?php /* Smarty version 2.6.20, created on 2015-08-04 20:06:31
         compiled from t_train.html */ ?>
...
?>
				<tr align=center>
					...
					<td>硬座：￥<?php echo $this->_tpl_vars['web']['price']; ?>
元<br> 软座：￥<?php echo $this->_tpl_vars['web']['price1']; ?>
元<br>
						硬卧：￥<?php echo $this->_tpl_vars['web']['price2']; ?>
元<br>
						软卧：￥<?php echo $this->_tpl_vars['web']['price3']; ?>
元
					</td>
...
'>
				<tr>
					<td width="14%" align="right">火车车次：</td>
