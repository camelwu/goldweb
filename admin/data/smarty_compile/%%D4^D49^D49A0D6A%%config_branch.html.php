<?php /* Smarty version 2.6.20, created on 2015-11-16 14:25:33
         compiled from config_branch.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'html_options', 'config_branch.html', 62, false),array('function', 'html_checkboxes', 'config_branch.html', 78, false),)), $this); ?>
...
-<?php echo $this->_tpl_vars['areatt'][$this->_tpl_vars['web']['city']]; ?>
			...
			<td><?php echo $this->_tpl_vars['Config']['templates'][$this->_tpl_vars['web']['templates']]; ?>
</td>
...
'>如：xxx.cgbt.net
		...
		<tr>
			<td>网站模板：</td>
			<td><select name='templates' id='templates'> <?php echo smarty_function_html_options(array('options' => $this->_tpl_vars['Config']['templates'],'selected' => $this->_tpl_vars['info']['templates']), $this);?>
		...
		<tr>
			...
			</select>&nbsp;&nbsp;&nbsp;&nbsp;<select name=aid> </select>&nbsp;&nbsp;&nbsp;&nbsp;<select name=city> </select></td>
		</tr>
		<tr>
			<td>业务范围：</td>
			<td><?php echo smarty_function_html_checkboxes(array('name' => 'op_stat','options' => $this->_tpl_vars['stat'],'checked' => $this->_tpl_vars['info']['op_stat'],'separator' => ' '), $this);?>
</td>
		</tr>
		<tr>
			<td>机构地址：</td>
			<td><input type=text name=addr size=20 value='<?php echo $this->_tpl_vars['info']['addr']; ?>
'>&nbsp;邮编：<input type=text name=zip size=20 value='<?php echo $this->_tpl_vars['info']['zip']; ?>
'></td>
		</tr>
		<tr>
			<td>机构方位：</td>
...
'>&nbsp;<font
		...
		<tr>
			<td>联系方式：</td>
			<td>Q&nbsp;Q：<input type=text name=qq size=20 value='<?php echo $this->_tpl_vars['info']['qq']; ?>
